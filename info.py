...
BOT_TOKEN = environ.get('BOT_TOKEN', "6273350573:AAFeUd6G8qFoDeW_ldmTkL2I6RJLcKIv25o")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001809139095').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1948970741').split()]
auth_channel = environ.get('AUTH_CHANNEL','-1001937911801')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '58bf1d72baaa507cf663a4f1832fbe258a900003')
