...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/abmoviezonehub')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AB_BotZ_Update')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/howtodownloadmovie1200')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Tʜᴀɴᴋ Yᴏᴜ Aᴍɪʀ❤️')
