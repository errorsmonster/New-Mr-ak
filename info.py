...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '6205528551').split()]
...
F2LINK_C = environ.get("F2LINK_C", "-1002053122232")
